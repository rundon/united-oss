...
public class DownLoad {
    ...
    private static String path = "http://192.168.16.212:8282/resources/20210730/318d17e102fe47deb66cbf10f1ea3cfa.doc";
    private static String filename = "D://318d17e102fe47deb66cbf10f1ea3cfa.doc";
    ...
    public static class DownloadThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                File file2 = new File("D://data/"+threadId + ".txt");
                if (file2.exists()) {
                ...
                if (openConnection.getResponseCode() == 206) {//200：请求全部资源成功， 206代表部分资源请求成功
                    ...
                    while ((length = inputStream.read(buffer)) != -1) {
                        ...
                        //创建随机文件保存当前线程下载的位置
                        File file = new File("D://data/"+threadId + ".txt");
                    ...
                    synchronized (DownloadThread.class) {
                        ...
                        if (runningTrheadCount == 0) {
                            ...
                            for (int i = 0; i < threadCount; i++) {
                                File file = new File("D://data/"+i + ".txt");
